# min_core_v9 — Complete Innovus PnR Command Script
...
set init_lef_file {lef/tech_v2_qrc.lef lef/team2stdcellsV3_qrc.lef}
...
floorPlan -coreMarginsBy die -site core -d 1060 1180 15 15 15 15
...
saveDesign checkpoint_after_power_v9.enc
...
place_design
saveDesign checkpoint_after_place_v9.enc

timeDesign -preCTS
timeDesign -preCTS -hold

optDesign -preCTS
saveDesign checkpoint_after_placeopt_v9.enc
...
saveDesign checkpoint_after_cts_hold_v9.enc
...
routeDesign
saveDesign checkpoint_after_route_v9.enc
...
saveDesign checkpoint_final_v9.enc
...
defOut -floorplan -routing -netlist core_top_pnr_v9_routed.def

streamOut core_top_pnr_v9.gds \
...
# File → Import → DEF
#   DEF File:            .../TSMC_180_work/core_top_pnr_v9_virtuoso.def
